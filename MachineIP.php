...
<?php
  echo '<font color="black" size="10" face="algerian"><center>Machine Learning IP Report<br></center></font>';
  echo "<br><br>";
  ...
  echo "<br><br>";
  $command = escapeshellcmd('MachineLearning\src\iplearning\python -W ignore runner2.py \"$query\"');
